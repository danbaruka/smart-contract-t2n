...
function isTxWithdrawalsMap(stuff) {
    ...
    return stuff.every(function (_a) {
        ...
        return (rewardAccount instanceof hashes_1.Hash28 ||
...
var TxWithdrawals = /** @class */ (function () {
    function TxWithdrawals(map, network) {
        ...
        if (Array.isArray(map)) {
            (0, assert_1.assert)(map.every(function (_a) {
                var rewardAccount = _a.rewardAccount, amount = _a.amount;
                return (rewardAccount !== undefined &&
                    amount !== undefined &&
                    (rewardAccount instanceof hashes_1.Hash28 ||
                        rewardAccount instanceof StakeAddress_1.StakeAddress) &&
            ...
            (0, assert_1.assert)(typeof map === "object", "invalid object passed as 'TxWithdrawalsMap' to construct a 'TxWithdrawals'");
    ...
    TxWithdrawals.fromCbor = function (cStr) {
        return TxWithdrawals.fromCborObj(cbor_1.Cbor.parse((0, cbor_1.forceCborString)(cStr)));
    };
    TxWithdrawals.fromCborObj = function (cObj) {
        ...
        return new TxWithdrawals(cObj.map.map(function (_a) {
            ...
            if (!(v instanceof cbor_1.CborUInt))
                throw new Error("Invalid CBOR fromat for \"TxWithdrawals\"");
            return {
                rewardAccount: hashes_1.Hash28.fromCborObj(k),
                amount: v.num
            };
        }));
    };
