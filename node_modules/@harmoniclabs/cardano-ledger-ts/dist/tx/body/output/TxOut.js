...
var TxOut = /** @class */ (function () {
    function TxOut(txOutput, subCborRef) {
    ...
    TxOut.fromCbor = function (cStr) {
        return TxOut.fromCborObj(cbor_1.Cbor.parse((0, cbor_1.forceCborString)(cStr), { keepRef: true }));
    };
    ...
    TxOut.prototype.toJSON = function () { return this.toJson(); };
