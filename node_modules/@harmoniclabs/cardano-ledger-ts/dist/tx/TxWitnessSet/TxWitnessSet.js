...
var VKeyWitness_1 = require("./VKeyWitness/index.js");
...
var TxWitnessSet = /** @class */ (function () {
    function TxWitnessSet(witnesses, subCborRef, allRequiredSigners) {
        if (allRequiredSigners === void 0) { allRequiredSigners = undefined; }
        var _this = this;
        var _a;
        this.subCborRef = subCborRef;
        (0, assert_1.assert)(isITxWitnessSet(witnesses), "invalid witnesses passed");
        var defGetter = function (name, get) {
            (0, obj_utils_1.definePropertyIfNotPresent)(_this, name, {
                get: get,
                set: function () { },
                enumerable: true,
                configurable: false
        ...
        var vkeyWitnesses = witnesses.vkeyWitnesses, bootstrapWitnesses = witnesses.bootstrapWitnesses, datums = witnesses.datums, nativeScripts = witnesses.nativeScripts, plutusV1Scripts = witnesses.plutusV1Scripts, plutusV2Scripts = witnesses.plutusV2Scripts, redeemers = witnesses.redeemers, plutusV3Scripts = witnesses.plutusV3Scripts;
        ...
        (0, obj_utils_1.defineReadOnlyProperty)(this, "addVKeyWitness", function (vkeyWit) {
            // if(
            //     noRequiredSigs ||
    ...
    TxWitnessSet.prototype.toJSON = function () { return this.toJson(); };
    ...
    TxWitnessSet.fromCbor = function (cStr) {
        return TxWitnessSet.fromCborObj(cbor_1.Cbor.parse((0, cbor_1.forceCborString)(cStr), { keepRef: true }));
    };
        ...
        return new TxWitnessSet({
            ...
            plutusV3Scripts: _plutusV3 === undefined ? undefined :
                (0, getCborSet_1.getCborSet)(_plutusV3).map(function (cbor) {
                    return new script_1.Script(script_1.ScriptType.PlutusV3, cbor_1.Cbor.encode(cbor).toBuffer());
                }),
...
function witnessRedeemersFromCborObj(cbor) {
    if (cbor instanceof cbor_1.CborArray) {
        return cbor.array.map(TxRedeemer_1.TxRedeemer.fromCborObj);
    }
    else if (cbor instanceof cbor_1.CborMap) {
        return cbor.map.map(TxRedeemer_1.TxRedeemer.fromCborMapEntry);
    }
    else
