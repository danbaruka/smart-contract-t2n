...
export type TxRedeemerTagStr<Tag extends TxRedeemerTag> = Tag extends TxRedeemerTag.Spend ? "Spend" : Tag extends TxRedeemerTag.Mint ? "Mint" : Tag extends TxRedeemerTag.Cert ? "Cert" : Tag extends TxRedeemerTag.Withdraw ? "Withdraw" : Tag extends TxRedeemerTag.Voting ? "Voting" : Tag extends TxRedeemerTag.Proposing ? "Proposing" : never;
...
export declare class TxRedeemer implements ITxRedeemer, ToCbor, Cloneable<TxRedeemer>, ToJson {
    ...
    **/
    readonly data: Data;
    execUnits: ExBudget;
    constructor(redeemer: ITxRedeemer, subCborRef?: SubCborRef | undefined);
    clone(): TxRedeemer;
