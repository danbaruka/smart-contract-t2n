...
var VKey = /** @class */ (function (_super) {
    ...
    function VKey(bs) {
        var _this = _super.call(this, bs) || this;
        var _hash = undefined;
        (0, obj_utils_1.definePropertyIfNotPresent)(_this, "hash", {
            get: function () {
                if (_hash instanceof PubKeyHash_1.PubKeyHash)
                    return _hash.clone();
                _hash = new PubKeyHash_1.PubKeyHash(Uint8Array.from((0, crypto_1.blake2b_224)(_this.toBuffer())));
                return _hash.clone();
            },
            set: function () { },
            enumerable: true,
