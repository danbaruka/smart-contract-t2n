...
var VKeyWitness = /** @class */ (function () {
    function VKeyWitness(vkey, signature, subCborRef) {
    ...
    VKeyWitness.fromCborObj = function (cObj) {
        ...
        return new VKeyWitness(Hash32_1.Hash32.fromCborObj(cObj.array[0]), Signature_1.Signature.fromCborObj(cObj.array[1]), (0, getSubCborRef_1.getSubCborRef)(cObj));
    };
