...
exports.GovActionNoConfidence = exports.isIGovActionNoConfidence = void 0;
...
function isIGovActionNoConfidence(stuff) {
    return (0, obj_utils_1.isObject)(stuff) && (stuff.govActionId === undefined || (0, tx_1.isITxOutRef)(stuff.govActionId));
}
exports.isIGovActionNoConfidence = isIGovActionNoConfidence;
var GovActionNoConfidence = /** @class */ (function () {
    function GovActionNoConfidence(_a, subCborRef) {
        var govActionId = _a.govActionId;
        this.subCborRef = subCborRef;
        Object.defineProperties(this, {
            govActionType: __assign({ value: GovActionType_1.GovActionType.NoConfidence }, roDescr_1.roDescr),
            govActionId: __assign({ value: (0, tx_1.isITxOutRef)(govActionId) ? new tx_1.TxOutRef(govActionId) : undefined }, roDescr_1.roDescr)
        });
    }
    GovActionNoConfidence.prototype.toCbor = function () {
    ...
    GovActionNoConfidence.prototype.toCborObj = function () {
        var _a, _b;
    ...
    GovActionNoConfidence.prototype.toData = function (v) {
        var _a;
    ...
    return GovActionNoConfidence;
}());
exports.GovActionNoConfidence = GovActionNoConfidence;
