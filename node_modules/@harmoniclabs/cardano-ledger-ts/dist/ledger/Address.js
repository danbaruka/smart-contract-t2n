...
var Address = /** @class */ (function () {
    function Address(network, paymentCreds, stakeCreds, type, subCborRef) {
        ...
        (0, assert_1.assert)(paymentCreds instanceof credentials_1.Credential, "invalid payment credentials");
    ...
    Object.defineProperty(Address, "fake", {
        get: function () {
            return new Address("mainnet", credentials_1.Credential.fake);
        },
        enumerable: false,
        configurable: true
    });
    ...
    Address.fromData = function (data, network) {
        ...
        if (!(maybeStakeCreds instanceof plutus_data_1.DataConstr))
            throw new Error("invalid data for address");
        return new Address(network, credentials_1.Credential.fromData(creds), maybeStakeCreds.constr >= 1 ? undefined : // nothing
    ...
    Address.fromBytes = function (bs, subCborRef) {
        ...
        return new Address(network, new credentials_1.Credential(paymentType, new hashes_1.Hash28(new Uint8Array(payment))), stake.length === 28 ?
            new credentials_1.StakeCredentials(stakeType, new hashes_1.Hash28(new Uint8Array(stake))) :
            undefined, type, subCborRef);
    };
    ;
    Address.prototype.toBuffer = function () {
        return new Uint8Array(this.toBytes());
    };
    Address.fromBuffer = function (buff, subCborRef) {
        return Address.fromBytes(typeof buff === "string" ?
            buff :
            Array.from(buff), subCborRef);
    };
    /**
    ...
    */
    Address.fromXPrv = function (xprv, network) {
        ...
        return new Address(network, credentials_1.Credential.keyHash(pkh), credentials_1.StakeCredentials.keyHash(stake_pkh));
    };
    /**
