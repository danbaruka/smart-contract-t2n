...
exports.CertStakeDelegation = void 0;
...
var CertStakeDelegation = /** @class */ (function () {
    function CertStakeDelegation(_a, subCborRef) {
        var stakeCredential = _a.stakeCredential, poolKeyHash = _a.poolKeyHash;
        this.subCborRef = subCborRef;
        Object.defineProperties(this, {
            certType: __assign({ value: CertificateType_1.CertificateType.StakeDelegation }, roDescr_1.roDescr),
    ...
    CertStakeDelegation.prototype.toData = function (version) {
    ...
    CertStakeDelegation.prototype.getRequiredSigners = function () {
        return [this.stakeCredential.hash.clone()];
    };
    CertStakeDelegation.prototype.toCbor = function () {
    ...
    CertStakeDelegation.prototype.toCborObj = function () {
    ...
    CertStakeDelegation.fromCborObj = function (cbor) {
        if (!(cbor instanceof cbor_1.CborArray &&
            cbor.array.length >= 3 &&
            cbor.array[0] instanceof cbor_1.CborUInt &&
            Number(cbor.array[0].num) === CertificateType_1.CertificateType.StakeDelegation))
    ...
    CertStakeDelegation.prototype.toJSON = function () { return this.toJson(); };
    CertStakeDelegation.prototype.toJson = function () {
        return {
    ...
    return CertStakeDelegation;
}());
exports.CertStakeDelegation = CertStakeDelegation;
